        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="name_starting" class="form-control" placeholder="Name" value="{{ $name_starting }}">
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="name_ending" class="form-control" placeholder="Name" value="{{ $name_ending }}">
                </div>
            </div>
